    ...
    'components' => array(
        ...
        'urlManager' => array(
            ...
            'rules' => array(
                ...
                '<module:(accounts|actions|calendar|charts|contacts|dashboard|docs|groups|marketing|media|opportunities|products|quotes|reports|users|workflow|services|bugReports|videoChat)>' => '<module>/<module>/index',
                '<module:(accounts|actions|calendar|charts|contacts|dashboard|docs|groups|marketing|media|opportunities|products|quotes|reports|users|workflow|services|bugReports|videoChat)>/<id:\d+>' => '<module>/<module>/view',
                '<module:(accounts|actions|calendar|charts|contacts|dashboard|docs|groups|marketing|media|opportunities|products|quotes|reports|users|workflow|services|bugReports|videoChat)>/<action:\w+>' => '<module>/<module>/<action>',
                '<module:(accounts|actions|calendar|charts|contacts|dashboard|docs|groups|marketing|media|opportunities|products|quotes|reports|users|workflow|services|bugReports|videoChat)>/<action:\w+>/<id:\d+>' => '<module>/<module>/<action>',
                '<module:(accounts|actions|calendar|charts|contacts|dashboard|docs|groups|marketing|media|opportunities|products|quotes|reports|users|workflow|services|bugReports|videoChat)>/<controller:\w+>/<id:\d+>' => '<module>/<module>/view',
                '<module:(accounts|actions|calendar|charts|contacts|dashboard|docs|groups|marketing|media|opportunities|products|quotes|reports|users|workflow|services|bugReports|videoChat)>/<controller:\w+>/<action:\w+>' => '<module>/<controller>/<action>',
                '<module:(accounts|actions|calendar|charts|contacts|dashboard|docs|groups|marketing|media|opportunities|products|quotes|reports|users|workflow|services|bugReports|videoChat)>/<controller:\w+>/<action:\w+>/<id:\d+>' => '<module>/<controller>/<action>',
