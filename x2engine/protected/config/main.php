    ...
    'components' => array(
        ...
        'urlManager' => array(
            ...
            'rules' => array(
                ...
                '<module:(accounts|actions|calendar|charts|contacts|dashboard|docs|groups|marketing|media|opportunities|products|quotes|reports|users|workflow|services|bugReports|chat|newsletters|editor)>' => '<module>/<module>/index',
                '<module:(accounts|actions|calendar|charts|contacts|dashboard|docs|groups|marketing|media|opportunities|products|quotes|reports|users|workflow|services|bugReports|chat|newsletters|editor)>/<id:\d+>' => '<module>/<module>/view',
                '<module:(accounts|actions|calendar|charts|contacts|dashboard|docs|groups|marketing|media|opportunities|products|quotes|reports|users|workflow|services|bugReports|chat|newsletters|editor)>/<action:\w+>' => '<module>/<module>/<action>',
                '<module:(accounts|actions|calendar|charts|contacts|dashboard|docs|groups|marketing|media|opportunities|products|quotes|reports|users|workflow|services|bugReports|chat|newsletters|editor)>/<action:\w+>/<id:\d+>' => '<module>/<module>/<action>',
                '<module:(accounts|actions|calendar|charts|contacts|dashboard|docs|groups|marketing|media|opportunities|products|quotes|reports|users|workflow|services|bugReports|chat|newsletters|editor)>/<controller:\w+>/<id:\d+>' => '<module>/<module>/view',
                '<module:(accounts|actions|calendar|charts|contacts|dashboard|docs|groups|marketing|media|opportunities|products|quotes|reports|users|workflow|services|bugReports|chat|newsletters|editor)>/<controller:\w+>/<action:\w+>' => '<module>/<controller>/<action>',
                '<module:(accounts|actions|calendar|charts|contacts|dashboard|docs|groups|marketing|media|opportunities|products|quotes|reports|users|workflow|services|bugReports|chat|newsletters|editor)>/<controller:\w+>/<action:\w+>/<id:\d+>' => '<module>/<controller>/<action>',
